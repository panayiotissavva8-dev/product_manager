...
# --- Clone Crow and ASIO headers if not already present ---
RUN mkdir -p external && \
    [ ! -d "external/crow" ] && git clone https://github.com/CrowCpp/Crow.git external/crow || echo "Crow exists" && \
    [ ! -d "external/asio" ] && git clone https://github.com/chriskohlhoff/asio.git external/asio || echo "ASIO exists"
...
# --- Start the app using PORT env variable ---
